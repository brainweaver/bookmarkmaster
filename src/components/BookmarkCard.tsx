            ...
            icon={
              archived ? (
                ...
                <svg width="13" height="13" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.35" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M2.5 3.5A1.5 1.5 0 0 1 4 2h8a1.5 1.5 0 0 1 1.5 1.5V5H2.5V3.5Z" fill="currentColor" stroke="none" />
                  <path d="M2.75 5.25h10.5v6.5A1.25 1.25 0 0 1 12 13H4a1.25 1.25 0 0 1-1.25-1.25v-6.5Z" />
                  <path d="M6.5 8h3" />
                </svg>
              )
            }
